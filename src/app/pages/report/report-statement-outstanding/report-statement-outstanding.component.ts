...
@Component({
  selector: 'app-report-statement-outstanding',
  templateUrl: './report-statement-outstanding.component.html',
  styleUrls: ['./report-statement-outstanding.component.scss']
})
export class ReportStatementOutstandingComponent {
  ...
  onExporting(e: any) {
    ...
    const worksheet = workbook.addWorksheet('Statement คงค้าง');
