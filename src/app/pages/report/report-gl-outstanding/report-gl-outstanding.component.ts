...
@Component({
  selector: 'app-report-gl-outstanding',
  templateUrl: './report-gl-outstanding.component.html',
  styleUrls: ['./report-gl-outstanding.component.scss']
})
export class ReportGlOutstandingComponent {
  ...
  onExporting(e: any) {
    ...
    const worksheet = workbook.addWorksheet('GL คงค้าง');
